...
class ResponseCache:
    """Simple in-memory cache with semantic similarity and privacy guardrails."""
    ...
    def similarity(a: str, b: str) -> float:
        """Compute semantic similarity between two strings using n-gram cosine."""
        if a == b:
            return 1.0
